...
GMLIB_API int    gmlib_sm4_ecb_encrypt_ctx_init(void*          ctx,
                                                ...
                                                size_t         user_key_len);
GMLIB_API int    gmlib_sm4_ecb_encrypt_ctx_reset(void* ctx);
GMLIB_API int    gmlib_sm4_ecb_encrypt_ctx_update(void*          ctx,
                                                  uint8_t*       out,
                                                  size_t*        outl,
                                                  const uint8_t* in,
                                                  size_t         inl);
GMLIB_API int    gmlib_sm4_ecb_encrypt_ctx_final_ex(void*          ctx,
                                                    uint8_t*       out,
                                                    size_t*        outl,
                                                    const uint8_t* in,
                                                    size_t         inl);
GMLIB_API int    gmlib_sm4_ecb_encrypt_ctx_final(void*    ctx,
                                                 uint8_t* out,
                                                 size_t*  outl);
...
GMLIB_API int    gmlib_sm4_ecb_decrypt_ctx_init(void*          ctx,
                                                const uint8_t* user_key,
                                                size_t         user_key_len);
GMLIB_API int    gmlib_sm4_ecb_decrypt_ctx_reset(void* ctx);
GMLIB_API int    gmlib_sm4_ecb_decrypt_ctx_update(void*          ctx,
                                                  uint8_t*       out,
                                                  size_t*        outl,
                                                  const uint8_t* in,
                                                  size_t         inl);
GMLIB_API int    gmlib_sm4_ecb_decrypt_ctx_final_ex(void*          ctx,
                                                    uint8_t*       out,
                                                    size_t*        outl,
                                                    const uint8_t* in,
                                                    size_t         inl);
GMLIB_API int    gmlib_sm4_ecb_decrypt_ctx_final(void*    ctx,
                                                 uint8_t* out,
                                                 size_t*  outl);
...
GMLIB_API int    gmlib_sm4_cbc_encrypt_ctx_init(void*          ctx,
                                                const uint8_t* user_key,
                                                size_t         user_key_len,
                                                const uint8_t* iv,
                                                size_t         iv_len);
GMLIB_API int    gmlib_sm4_cbc_encrypt_ctx_reset(void*          ctx,
                                                 const uint8_t* iv,
                                                 size_t         iv_len);
GMLIB_API int    gmlib_sm4_cbc_encrypt_ctx_update(void*          ctx,
                                                  uint8_t*       out,
                                                  size_t*        outl,
                                                  const uint8_t* in,
                                                  size_t         inl);
GMLIB_API int    gmlib_sm4_cbc_encrypt_ctx_final_ex(void*          ctx,
                                                    uint8_t*       out,
                                                    size_t*        outl,
                                                    const uint8_t* in,
                                                    size_t         inl);
GMLIB_API int    gmlib_sm4_cbc_encrypt_ctx_final(void*    ctx,
                                                 uint8_t* out,
                                                 size_t*  outl);
...
GMLIB_API int    gmlib_sm4_cbc_decrypt_ctx_init(void*          ctx,
                                                const uint8_t* user_key,
                                                size_t         user_key_len,
                                                const uint8_t* iv,
                                                size_t         iv_len);
GMLIB_API int    gmlib_sm4_cbc_decrypt_ctx_reset(void*          ctx,
                                                 const uint8_t* iv,
                                                 size_t         iv_len);
GMLIB_API int    gmlib_sm4_cbc_decrypt_ctx_update(void*          ctx,
                                                  uint8_t*       out,
                                                  size_t*        outl,
                                                  const uint8_t* in,
                                                  size_t         inl);
GMLIB_API int    gmlib_sm4_cbc_decrypt_ctx_final_ex(void*          ctx,
                                                    uint8_t*       out,
                                                    size_t*        outl,
                                                    const uint8_t* in,
                                                    size_t         inl);
GMLIB_API int    gmlib_sm4_cbc_decrypt_ctx_final(void*    ctx,
                                                 uint8_t* out,
                                                 size_t*  outl);
...
GMLIB_API int    gmlib_sm4_cfb_encrypt_ctx_init(void*          ctx,
                                                const uint8_t* user_key,
                                                size_t         user_key_len,
                                                const uint8_t* iv,
                                                size_t         iv_len);
GMLIB_API int    gmlib_sm4_cfb_encrypt_ctx_reset(void*          ctx,
                                                 const uint8_t* iv,
                                                 size_t         iv_len);
GMLIB_API int    gmlib_sm4_cfb_encrypt_ctx_update(void*          ctx,
                                                  uint8_t*       out,
                                                  size_t*        outl,
                                                  const uint8_t* in,
                                                  size_t         inl);
GMLIB_API int    gmlib_sm4_cfb_encrypt_ctx_final_ex(void*          ctx,
                                                    uint8_t*       out,
                                                    size_t*        outl,
                                                    const uint8_t* in,
                                                    size_t         inl);
GMLIB_API int    gmlib_sm4_cfb_encrypt_ctx_final(void*    ctx,
                                                 uint8_t* out,
                                                 size_t*  outl);
...
GMLIB_API int    gmlib_sm4_cfb_decrypt_ctx_init(void*          ctx,
                                                const uint8_t* user_key,
                                                size_t         user_key_len,
                                                const uint8_t* iv,
                                                size_t         iv_len);
GMLIB_API int    gmlib_sm4_cfb_decrypt_ctx_reset(void*          ctx,
                                                 const uint8_t* iv,
                                                 size_t         iv_len);
GMLIB_API int    gmlib_sm4_cfb_decrypt_ctx_update(void*          ctx,
                                                  uint8_t*       out,
                                                  size_t*        outl,
                                                  const uint8_t* in,
                                                  size_t         inl);
GMLIB_API int    gmlib_sm4_cfb_decrypt_ctx_final_ex(void*          ctx,
                                                    uint8_t*       out,
                                                    size_t*        outl,
                                                    const uint8_t* in,
                                                    size_t         inl);
GMLIB_API int    gmlib_sm4_cfb_decrypt_ctx_final(void*    ctx,
                                                 uint8_t* out,
                                                 size_t*  outl);
...
GMLIB_API int    gmlib_sm4_ofb_encrypt_ctx_init(void*          ctx,
                                                const uint8_t* user_key,
                                                size_t         user_key_len,
                                                const uint8_t* iv,
                                                size_t         iv_len);
GMLIB_API int    gmlib_sm4_ofb_encrypt_ctx_reset(void*          ctx,
                                                 const uint8_t* iv,
                                                 size_t         iv_len);
GMLIB_API int    gmlib_sm4_ofb_encrypt_ctx_update(void*          ctx,
                                                  uint8_t*       out,
                                                  size_t*        outl,
                                                  const uint8_t* in,
                                                  size_t         inl);
GMLIB_API int    gmlib_sm4_ofb_encrypt_ctx_final_ex(void*          ctx,
                                                    uint8_t*       out,
                                                    size_t*        outl,
                                                    const uint8_t* in,
                                                    size_t         inl);
GMLIB_API int    gmlib_sm4_ofb_encrypt_ctx_final(void*    ctx,
                                                 uint8_t* out,
                                                 size_t*  outl);
...
GMLIB_API int    gmlib_sm4_ofb_decrypt_ctx_init(void*          ctx,
                                                const uint8_t* user_key,
                                                size_t         user_key_len,
                                                const uint8_t* iv,
                                                size_t         iv_len);
GMLIB_API int    gmlib_sm4_ofb_decrypt_ctx_reset(void*          ctx,
                                                 const uint8_t* iv,
                                                 size_t         iv_len);
GMLIB_API int    gmlib_sm4_ofb_decrypt_ctx_update(void*          ctx,
                                                  uint8_t*       out,
                                                  size_t*        outl,
                                                  const uint8_t* in,
                                                  size_t         inl);
GMLIB_API int    gmlib_sm4_ofb_decrypt_ctx_final_ex(void*          ctx,
                                                    uint8_t*       out,
                                                    size_t*        outl,
                                                    const uint8_t* in,
                                                    size_t         inl);
GMLIB_API int    gmlib_sm4_ofb_decrypt_ctx_final(void*    ctx,
                                                 uint8_t* out,
                                                 size_t*  outl);
...
GMLIB_API int    gmlib_sm4_ctr_encrypt_ctx_init(void*          ctx,
                                                const uint8_t* user_key,
                                                size_t         user_key_len,
                                                const uint8_t* iv,
                                                size_t         iv_len);
GMLIB_API int    gmlib_sm4_ctr_encrypt_ctx_reset(void*          ctx,
                                                 const uint8_t* iv,
                                                 size_t         iv_len);
GMLIB_API int    gmlib_sm4_ctr_encrypt_ctx_update(void*          ctx,
                                                  uint8_t*       out,
                                                  size_t*        outl,
                                                  const uint8_t* in,
                                                  size_t         inl);
GMLIB_API int    gmlib_sm4_ctr_encrypt_ctx_final_ex(void*          ctx,
                                                    uint8_t*       out,
                                                    size_t*        outl,
                                                    const uint8_t* in,
                                                    size_t         inl);
GMLIB_API int    gmlib_sm4_ctr_encrypt_ctx_final(void*    ctx,
                                                 uint8_t* out,
                                                 size_t*  outl);
...
GMLIB_API int    gmlib_sm4_ctr_decrypt_ctx_init(void*          ctx,
                                                const uint8_t* user_key,
                                                size_t         user_key_len,
                                                const uint8_t* iv,
                                                size_t         iv_len);
GMLIB_API int    gmlib_sm4_ctr_decrypt_ctx_reset(void*          ctx,
                                                 const uint8_t* iv,
                                                 size_t         iv_len);
GMLIB_API int    gmlib_sm4_ctr_decrypt_ctx_update(void*          ctx,
                                                  uint8_t*       out,
                                                  size_t*        outl,
                                                  const uint8_t* in,
                                                  size_t         inl);
GMLIB_API int    gmlib_sm4_ctr_decrypt_ctx_final_ex(void*          ctx,
                                                    uint8_t*       out,
                                                    size_t*        outl,
                                                    const uint8_t* in,
                                                    size_t         inl);
GMLIB_API int    gmlib_sm4_ctr_decrypt_ctx_final(void*    ctx,
                                                 uint8_t* out,
                                                 size_t*  outl);
...
GMLIB_API size_t gmlib_sm4_gcm_encrypt_get_tag_len();
GMLIB_API int    gmlib_sm4_gcm_encrypt_ctx_init(void*          ctx,
                                                const uint8_t* user_key,
                                                size_t         user_key_len,
                                                const uint8_t* iv,
                                                size_t         iv_len,
                                                const uint8_t* aad,
                                                size_t         aad_len);
GMLIB_API int    gmlib_sm4_gcm_encrypt_ctx_reset(void*          ctx,
                                                 const uint8_t* iv,
                                                 size_t         iv_len,
                                                 const uint8_t* aad,
                                                 size_t         aad_len);
GMLIB_API int    gmlib_sm4_gcm_encrypt_ctx_update(void*          ctx,
                                                  uint8_t*       out,
                                                  size_t*        outl,
                                                  const uint8_t* in,
                                                  size_t         inl);
GMLIB_API int    gmlib_sm4_gcm_encrypt_ctx_final_ex(void*          ctx,
                                                    uint8_t*       out,
                                                    size_t*        outl,
                                                    const uint8_t* in,
                                                    size_t         inl);
GMLIB_API int    gmlib_sm4_gcm_encrypt_ctx_final(void*    ctx,
                                                 uint8_t* out,
                                                 size_t*  outl);
...
GMLIB_API size_t gmlib_sm4_gcm_decrypt_get_tag_len();
GMLIB_API int    gmlib_sm4_gcm_decrypt_ctx_init(void*          ctx,
                                                const uint8_t* user_key,
                                                size_t         user_key_len,
                                                const uint8_t* iv,
                                                size_t         iv_len,
                                                const uint8_t* aad,
                                                size_t         aad_len);
GMLIB_API int    gmlib_sm4_gcm_decrypt_ctx_reset(void*          ctx,
                                                 const uint8_t* iv,
                                                 size_t         iv_len,
                                                 const uint8_t* aad,
                                                 size_t         aad_len);
GMLIB_API int    gmlib_sm4_gcm_decrypt_ctx_update(void*          ctx,
                                                  uint8_t*       out,
                                                  size_t*        outl,
                                                  const uint8_t* in,
                                                  size_t         inl);
GMLIB_API int    gmlib_sm4_gcm_decrypt_ctx_final_ex(void*          ctx,
                                                    uint8_t*       out,
                                                    size_t*        outl,
                                                    const uint8_t* in,
                                                    size_t         inl);
GMLIB_API int    gmlib_sm4_gcm_decrypt_ctx_final(void*    ctx,
                                                 uint8_t* out,
                                                 size_t*  outl);
GMLIB_API int gmlib_sm4_gcm_encrypt_ctx_set_tag(void* ctx, const uint8_t* tag);
