...
static const NumberProvider number_providers[] = {
...
#if defined(SUPPORT_NUMBER_X64)
    {
        ...
        reinterpret_cast<decltype(NumberProvider::uint256_add_carry_uint32)>(
            internal::x64::uint256_add_carry_uint32),
        reinterpret_cast<decltype(NumberProvider::uint256_add_carry_uint64)>(
            internal::x64::uint256_add_carry_uint64),
        reinterpret_cast<decltype(NumberProvider::uint256_sub_borrow_uint32)>(
            internal::x64::uint256_sub_borrow_uint32),
        reinterpret_cast<decltype(NumberProvider::uint256_sub_borrow_uint64)>(
            internal::x64::uint256_sub_borrow_uint64),
        reinterpret_cast<decltype(NumberProvider::uint256_mul_carry_uint32)>(
            internal::x64::uint256_mul_carry_uint32),
        reinterpret_cast<decltype(NumberProvider::uint256_mul_carry_uint64)>(
...
static const NumberProvider* find_provider(const char* impl) noexcept
{
    for (const NumberProvider& provider : number_providers)
    {
...
const NumberProvider* get_provider(const char* impl) noexcept
{
    if (impl == nullptr)
    {
        static const NumberProvider* provider = find_provider(nullptr);
        return provider;
    }
