...
int main()
{
    ...
    // fetch cipher
    cipher = EVP_CIPHER_fetch(NULL, "UBLOCK-256-ECB-128", "provider=gmlibprov");
    if (cipher == NULL)
    {
    ...
    printf("[%d] EVP Cipher UBLOCK-256-ECB-128 start\n", __LINE__);
    ...
    printf("[%d] EVP CIPHER UBLOCK-256-ECB-128 PASS\n", __LINE__);
