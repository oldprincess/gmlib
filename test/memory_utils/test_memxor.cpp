...
void test_memxor()
{
    ...
    for (int i = 0; i < 100; i++)
    {
        ...
        // test memxor 1
        rand_mem(mem4, SIZE);
        memory_utils::memxor_n(mem4, mem1, mem2, 1);
        ...
        // test memxor 2
        rand_mem(mem4, SIZE);
        memory_utils::memxor_n(mem4, mem1, mem2, 2);
        ...
        // test memxor 4
        rand_mem(mem4, SIZE);
        memory_utils::memxor_n(mem4, mem1, mem2, 4);
        ...
        // test memxor 8
        rand_mem(mem4, SIZE);
        memory_utils::memxor_n(mem4, mem1, mem2, 8);
        ...
        // test memxor 16
        rand_mem(mem4, SIZE);
        memory_utils::memxor_n(mem4, mem1, mem2, 16);
        ...
        // test memxor 32
        rand_mem(mem4, SIZE);
        memory_utils::memxor_n(mem4, mem1, mem2, 32);
        ...
        // test memxor 64
        rand_mem(mem4, SIZE);
        memory_utils::memxor_n(mem4, mem1, mem2, 64);
        ...
        // test memxor 128
        rand_mem(mem4, SIZE);
        memory_utils::memxor_n(mem4, mem1, mem2, 128);
        ...
        // test memxor 256
        rand_mem(mem4, SIZE);
        memory_utils::memxor_n(mem4, mem1, mem2, 256);
        ...
        // test memxor 512
        rand_mem(mem4, SIZE);
        memory_utils::memxor_n(mem4, mem1, mem2, 512);
