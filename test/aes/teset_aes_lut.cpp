...
static void test_aes128_lut()
{
    ...
    {
        throw std::runtime_error("err in aes128 lut");
    }
...
static void test_aes192_lut()
{
    ...
    {
        throw std::runtime_error("err in aes192 lut");
    }
...
static void test_aes256_lut()
{
    ...
    {
        throw std::runtime_error("err in aes256 lut");
    }
