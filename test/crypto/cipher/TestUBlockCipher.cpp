#include <gmlib/crypto/cipher/UBlockCipher.h>
...
void TestUBlockCipher()
{
    ...
    auto ublock128128 = UBlock128128Cipher();
    ublock128128.set_key(key128128, UBlock128128Cipher::ENCRYPTION);
    ublock128128.crypt_block(out, pt128128);
    if (memcmp(ct128128, out, UBlock128128Cipher::BLOCK_SIZE) != 0)
    {
        throw gmlib::Exception("Error in UBlockCipher Encryption Mode");
    }
    ...
    ublock128128.set_key(key128128, UBlock128128Cipher::DECRYPTION);
    ublock128128.crypt_block(out, ct128128);
    if (memcmp(pt128128, out, UBlock128128Cipher::BLOCK_SIZE) != 0)
    {
        throw gmlib::Exception("Error in UBlockCipher Decryption Mode");
    }
    ...
    auto ublock128256 = UBlock128256Cipher();
    ublock128256.set_key(key128256, UBlock128256Cipher::ENCRYPTION);
    ublock128256.crypt_block(out, pt128256);
    if (memcmp(ct128256, out, UBlock128256Cipher::BLOCK_SIZE) != 0)
    {
        throw gmlib::Exception("Error in UBlockCipher Encryption Mode");
    }
    ...
    ublock128256.set_key(key128256, UBlock128256Cipher::DECRYPTION);
    ublock128256.crypt_block(out, ct128256);
    if (memcmp(pt128256, out, UBlock128256Cipher::BLOCK_SIZE) != 0)
    {
        throw gmlib::Exception("Error in UBlockCipher Decryption Mode");
    }
    ...
    auto ublock256256 = UBlock256256Cipher();
    ublock256256.set_key(key256256, UBlock256256Cipher::ENCRYPTION);
    ublock256256.crypt_block(out, pt256256);
    if (memcmp(ct256256, out, UBlock256256Cipher::BLOCK_SIZE) != 0)
    {
        throw gmlib::Exception("Error in UBlockCipher Encryption Mode");
    }
    ...
    ublock256256.set_key(key256256, UBlock256256Cipher::DECRYPTION);
    ublock256256.crypt_block(out, ct256256);
    if (memcmp(pt256256, out, UBlock256256Cipher::BLOCK_SIZE) != 0)
    {
        throw gmlib::Exception("Error in UBlockCipher Decryption Mode");
    }
